...
from engine.cli.execution import ContextInitializer, PipelineExecutor
from engine.cli.template import handle_template_command
...
def _load_context_from_dsl(config_path: Optional[Union[str, Path]]) -> Any:
    ...
    from engine.config.contexts import Context, ContextFactory
...
def _run_streaming_impl(
    ...
    try:
        ...
        from engine.exec.executor import PipelineExecutor
