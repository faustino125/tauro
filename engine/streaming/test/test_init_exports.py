...
class TestStreamingExports:
    ...
    def test_validators_exports(self):
        ...
        from engine.streaming import StreamingValidator
    ...
    def test_all_attribute(self):
        ...
        assert hasattr(engine.streaming, "__all__")
        all_exports = engine.streaming.__all__
    ...
    def test_import_all_wildcard(self):
        ...
        namespace = {}
        exec("from engine.streaming import *", namespace)
    ...
    def test_docstring_present(self):
        ...
        assert engine.streaming.__doc__ is not None
        assert len(engine.streaming.__doc__) > 0
        assert "Tauro Streaming" in engine.streaming.__doc__

    def test_base_classes_abstract(self):
        """Verificar que las clases base son abstractas."""
        from abc import ABC
        from engine.streaming import BaseStreamingReader, BaseStreamingWriter
    ...
    def test_utility_functions(self):
        ...
        from engine.streaming import handle_streaming_error, create_error_context
        ...
        from engine.streaming import StreamingError
