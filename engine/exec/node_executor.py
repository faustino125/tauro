...
from engine.exec.commands import Command, MLNodeCommand, NodeCommand
...
from engine.exec.resource_pool import get_default_resource_pool
...
class NodeExecutor:
    ...
    def _import_module_with_fallback(self, module_path: str):
        ...
        allowed_prefixes = getattr(
            ...
            ["engine.", "nodes.", "custom_nodes.", "src.", "lib."],
        )
