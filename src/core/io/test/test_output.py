...
class TestDataFrameConverter:
    ...
    def test_convert_to_spark_with_pandas(self, converter, monkeypatch):
        ...
        monkeypatch.setattr("core.io.output.pd", mock_pd, raising=False)
    ...
    def test_convert_to_spark_with_polars(self, converter, monkeypatch):
        ...
        monkeypatch.setattr("core.io.output.pd", mock_pd, raising=False)
        monkeypatch.setattr("core.io.output.pl", mock_pl, raising=False)
    ...
    def test_convert_to_spark_unsupported_type(self, converter, monkeypatch):
        ...
        monkeypatch.setattr("core.io.output.pd", None, raising=False)
        monkeypatch.setattr("core.io.output.pl", None, raising=False)
