...
from core.io.exceptions import ConfigurationError, WriteOperationError
...
def noop_data_validator(monkeypatch):
    ...
    """
    monkeypatch.setattr(
        "core.io.writers.DataValidator.validate_dataframe",
        lambda self, df, allow_empty=False: None,
    )
    monkeypatch.setattr(
        "core.io.writers.DataValidator.validate_columns_exist",
