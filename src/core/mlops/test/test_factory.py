...
from core.mlops.config import (
    StorageBackendFactory,
    ExperimentTrackerFactory,
    ModelRegistryFactory,
)
from core.mlops.storage import LocalStorageBackend, DatabricksStorageBackend
...
class TestStorageBackendFactory:
    ...
    def test_create_databricks_backend(self, monkeypatch):
        ...
        monkeypatch.setattr("core.mlops.storage.databricks", mock_databricks, raising=False)
...
class TestConvenienceAliases:
    ...
    def test_create_storage_backend_alias(self):
        ...
        from core.mlops.config import create_storage_backend
    ...
    def test_create_experiment_tracker_alias(self):
        ...
        from core.mlops.config import create_experiment_tracker
    ...
    def test_create_model_registry_alias(self):
        ...
        from core.mlops.config import create_model_registry
