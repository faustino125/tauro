...
streaming_pm_mod = pytest.importorskip(
    "core.streaming.pipeline_manager",
    reason="StreamingPipelineManager not available in core.streaming.pipeline_manager",
)
StreamingPipelineManager = getattr(streaming_pm_mod, "StreamingPipelineManager", None)
if StreamingPipelineManager is None:
    pytest.skip("StreamingPipelineManager class not found in core.streaming.pipeline_manager")

from core.streaming.validators import (
    StreamingValidator,
