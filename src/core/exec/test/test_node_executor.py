...
tauro_exec_mod = pytest.importorskip(
    "core.exec.node_executor",
    reason="NodeExecutor not available in core.exec.node_executor",
)
NodeExecutor = getattr(tauro_exec_mod, "NodeExecutor", None)
if NodeExecutor is None:
    pytest.skip("NodeExecutor class not found in core.exec.node_executor")
