...
from tauro.cli.core import ConfigFormat, ExitCode
from tauro.cli.template import (
    TemplateType,
    TemplateError,
    BaseTemplate,
...
class TestTemplateError:
    ...
    def test_template_error_inherits_from_tauro_error(self):
        ...
        from tauro.cli.core import TauroError
...
class TestTemplateGeneratorExecution:
    ...
    def test_generate_project_without_yaml_library(self, monkeypatch):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            import tauro.cli.template as template_module
