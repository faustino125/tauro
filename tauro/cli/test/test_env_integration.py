...
Integration tests for environment handling across Tauro.
...
from tauro.cli.config import AppConfigManager, ConfigurationError
from tauro.cli.validators import EnvironmentConfigValidator, ValidationSeverity
from tauro.common import CanonicalEnvironment, get_fallback_chain
...
class TestAllowedEnvironments:
    ...
    def test_is_not_allowed_invalid(self):
        ...
        # Note: may be allowed if TAURO_ALLOWED_ENVS is set
